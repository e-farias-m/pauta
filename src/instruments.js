...
const RECORDER_SOPRANO_FINGERINGS = {
  ...
  64:'012345',     65:'012346789', 66:'0123567',   67:'0123',
...
const CLARINET_FINGERINGS = {
  ...
  71:'000111000100',  // B4  — Reg + L1 L2 L3 + R2
   72:'010110001000',  // C5  — Th + L1 L2 L3 + R1 (long C)
  73:'000110100000',  // C#5 — Reg + L1 L2 L3 + C#
  74:'000100000000',  // D5  — Reg + L1 L2
   // ── Altissimo ────────────────────────────────────────────────
   75:'000111100000',  // Eb5 — Reg + L1 L2 L3 + R1 (fork)
   76:'000100100100',  // E5  — Reg + L1 L2 + G# + R1 R2
   77:'000000100100',  // F5  — Reg + G# + R1 R2
   78:'010000001100',  // F#5 — Th + G# + R2 R3
   79:'011000001000',  // G5  — Th + L1 + G# + R2
   80:'011100001000',  // G#5 — Th + L1 L2 + G# + R2
   81:'011110001000',  // A5  — Th + L1 L2 L3 + G# + R2
   82:'011111001000',  // Bb5 — Th + L1 L2 L3 + Eb + G# + R2
   83:'011111101000',  // B5  — Th + L1 L2 L3 + Eb + C# + G# + R2
   84:'011100001110',  // C6  — Th + L1 L2 L3 + R2 R3 R4
};
